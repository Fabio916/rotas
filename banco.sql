...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Out-2023 às 03:18
...
(4, 'Vila lobos', 'Folclore teste', '444-5-18-169611-0', '50', 50),
...
(1, 'Yasmin Souza', '(11) 99999-999', 'souza156@gmail.com', '496.300.258-24'),
(2, 'Otavio Nunes ', '(11) 96692-101', 'nunesotavio@outlook.com', '936.599.302-18'),
(3, 'Carlos Souza', '(11) 9863-2201', 'carlos99@gmail.com', '225.630.268-21');
...
--
ALTER TABLE `cliente`
  MODIFY `Cod_Cli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `compra`
--
ALTER TABLE `compra`
  MODIFY `Cod_Comp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
('root', '[{\"db\":\"bd_autoria\",\"table\":\"livro\"},{\"db\":\"bd_autoria\",\"table\":\"autoria\"},{\"db\":\"bd_autoria\",\"table\":\"autor\"},{\"db\":\"laravel\",\"table\":\"produtos_tabela\"},{\"db\":\"laravel\",\"table\":\"users\"},{\"db\":\"laravel\",\"table\":\"migrations\"},{\"db\":\"clientes\",\"table\":\"tbclientes\"},{\"db\":\"viewproject\",\"table\":\"users\"},{\"db\":\"exemplocurso\",\"table\":\"produto\"},{\"db\":\"livraria\",\"table\":\"funcionario\"}]');
...
('root', '2023-10-21 00:38:24', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Banco de dados: `rotas`
--
CREATE DATABASE IF NOT EXISTS `rotas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `rotas`;
...
--
CREATE DATABASE IF NOT EXISTS `viewproject` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `viewproject`;
